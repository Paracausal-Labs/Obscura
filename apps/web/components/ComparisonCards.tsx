...
export function ComparisonCards() {
    return (
        <section className="relative w-full py-24 md:py-32 bg-[#07080a] overflow-hidden">
            ...
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[500px] h-[250px] rounded-full blur-[120px] opacity-[0.05] pointer-events-none" style={{ background: "#ff0033" }} />
            <div className="absolute top-0 left-[5%] w-[500px] h-[400px] rounded-full blur-[160px] opacity-[0.04] pointer-events-none bg-zinc-300" />
            <div className="absolute top-[20%] right-0 w-[400px] h-[400px] rounded-full blur-[140px] opacity-[0.03] pointer-events-none bg-zinc-200" />
            ...
            <div className="max-w-[1400px] mx-auto px-6 md:px-10">
                ...
                >
                    <p className="text-[#ff0033] uppercase tracking-widest text-[11px] font-semibold mb-3">Comparison</p>
                    <h2 className="text-4xl md:text-5xl font-light text-white tracking-tight">Built differently, by design</h2>
                </motion.div>
                ...
                <div className="relative rounded-[2rem] border border-[#ff0033]/12 bg-[#0c0d12] p-5 md:p-6 overflow-hidden shadow-[0_0_0_1px_rgba(255,0,51,0.08),inset_0_0_60px_rgba(255,0,51,0.03)]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <motion.div
                            ...
                            className="relative rounded-2xl border border-[#ff0033]/15 bg-[#0a0b0f] overflow-hidden"
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2.5 px-5 py-4 border-b border-white/5">
                                ...
                                <span className="ml-auto px-2.5 py-0.5 rounded-full bg-[#ff0033]/10 border border-[#ff0033]/15 text-[#ff0033] text-[9px] font-semibold uppercase tracking-wider">Private Execution</span>
                            </div>
                            <div className="p-3 space-y-2">
                                {rows.map((row, i) => (
                                    ...
                                    >
                                        ...
                                        <div>
                                            <p className="text-zinc-600 text-[9px] uppercase tracking-widest font-semibold mb-0.5">{row.feature}</p>
                        ...
                        >
                            <div className="flex items-center gap-2.5 px-5 py-4 border-b border-white/5">
                                ...
                                <h3 className="text-zinc-500 font-semibold text-base">Agentropolis</h3>
                                <span className="ml-auto px-2.5 py-0.5 rounded-full bg-white/4 border border-white/6 text-zinc-600 text-[9px] font-semibold uppercase tracking-wider">General Purpose</span>
                            </div>
                            <div className="p-3 space-y-2">
                                {rows.map((row, i) => (
                                    <motion.div key={row.feature}
                                        initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}
                                        transition={{ delay: i * 0.06 }} viewport={{ once: true }}
                                        className="flex items-start gap-3 p-3.5 rounded-xl bg-white/1 border border-white/4"
                                    >
                                        <span className="flex-shrink-0 w-4 h-4 rounded-full bg-white/4 flex items-center justify-center mt-0.5">
                                            <X size={9} className="text-zinc-600" />
                                        </span>
                                        <div>
                                            <p className="text-zinc-700 text-[9px] uppercase tracking-widest font-semibold mb-0.5">{row.feature}</p>
                                            <p className="text-zinc-500 text-xs">{row.agentropolis}</p>
                                        </div>
                                    </motion.div>
                                ))}
                            </div>
