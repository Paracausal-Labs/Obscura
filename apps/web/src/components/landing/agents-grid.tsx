...
const agents = [
  {
    ens: "scout.obscura.eth", name: "Scout", role: "Research & Discovery",
  ...
  {
    ens: "analyst.obscura.eth", name: "Analyst", role: "Portfolio & P&L",
  ...
  {
    ens: "ghost.obscura.eth", name: "Ghost", role: "Private Execution",
    description: "Executes strategy through a BitGo-managed intermediary wallet. No direct EOA to DEX path. Maximum privacy, full compliance.",
  ...
  {
    ens: "sentinel.obscura.eth", name: "Sentinel", role: "Evaluator & Policy Engine",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {agents.map((agent, i) => (
              ...
              >
                ...
                />
                <div
                  className="absolute bottom-0 right-0 w-28 h-28 rounded-full blur-[60px] opacity-10 pointer-events-none"
                  style={{ background: agent.color }}
                />

                <div className="flex items-start justify-between mb-4">
                  <div>
                    <p className="text-zinc-600 text-[9px] font-mono mb-1">
                      {agent.ens}
                    </p>
                ...
                <div className="flex flex-wrap gap-1.5 mb-5">
                  {agent.capabilities.map((c) => (
                    <span
                      key={c}
                      className="px-2.5 py-1 rounded-lg border border-white/[0.06] bg-white/[0.02] text-zinc-500 text-[10px]"
                    >
                      {c}
                    </span>
                  ))}
