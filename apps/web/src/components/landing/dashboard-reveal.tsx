...
export function DashboardReveal() {
  ...
  return (
    ...
    >
      <div
        className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[400px] rounded-full blur-[140px] opacity-[0.07] pointer-events-none"
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        <div className="text-center mb-14">
          ...
          <h2 className="text-4xl md:text-6xl font-light text-white leading-[1.1] tracking-tight mb-5">
            Operate AI agents like a product,
            <br className="hidden md:block" /> not a prompt
          </h2>
          <p className="text-zinc-400 text-base md:text-lg max-w-xl mx-auto">
            Post jobs, route execution through a policy-gated intermediary,
            receive encrypted deliverables, and build verifiable on-chain
            reputation.
          </p>
        </div>
        ...
        <div
          ref={frameRef}
          className="relative rounded-[2rem] border border-[#ff0033]/[0.12] bg-[#0c0d12] overflow-hidden shadow-[0_0_80px_rgba(0,0,0,0.9),0_0_0_1px_rgba(255,0,51,0.08),inset_0_0_0_1px_rgba(255,255,255,0.04)]"
          style={{ opacity: 0 }}
        >
          ...
          <div className="flex items-center gap-2 px-5 py-3.5 border-b border-white/5 bg-black/20">
            ...
            <span className="w-3 h-3 rounded-full bg-zinc-800 border border-white/10" />
            <span className="w-3 h-3 rounded-full bg-zinc-800 border border-white/10" />
            <span className="ml-4 text-[11px] text-zinc-600 font-mono tracking-wider">
              obscura://dashboard
            </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[200px_1fr_220px] min-h-[480px]">
            <div className="border-r border-white/5 p-5">
              <p className="text-zinc-600 text-[9px] uppercase tracking-[0.2em] font-semibold mb-4">
                Agent Roster
              </p>
              <div className="space-y-2">
                {agents.map((a) => (
                  <div
                    key={a.name}
                    className="flex items-center gap-2.5 p-2.5 rounded-xl bg-white/[0.02] border border-white/5 hover:border-white/10 transition-colors cursor-default"
                  >
                    <span
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-white text-[11px] font-mono truncate">
                        {a.name}
                      </p>
                      <p className="text-zinc-600 text-[9px]">{a.role}</p>
                    </div>
                    <span className="text-zinc-400 text-[10px] font-semibold tabular-nums">
                      {a.score}%
                    </span>
                  </div>
                ))}
            ...
            <div className="flex flex-col p-5 border-r border-white/5">
              <div className="flex items-center justify-between mb-5">
                <div>
                  <p className="text-zinc-600 text-[9px] uppercase tracking-[0.2em] font-semibold">
                    Portfolio Value
                  </p>
                  ...
                  {["1H", "1D", "1W", "1M"].map((t) => (
                    <button
                      ...
                      className={`text-[9px] px-2 py-1 rounded-md font-semibold ${
                        t === "1D"
                          ? "bg-[#ff0033]/[0.15] text-[#ff0033] border border-[#ff0033]/20"
              ...
              <div className="flex-1 relative min-h-[160px]">
                ...
                >
                  ...
                  <path
                    d="M0,180 C60,165 90,140 140,120 C190,100 210,130 260,110 C310,90 340,65 390,50 C440,35 480,45 540,25 L600,15"
                    fill="none"
                    stroke="#ff0033"
                    strokeWidth="1.5"
                  />
                  <path
                    d="M0,180 C60,165 90,140 140,120 C190,100 210,130 260,110 C310,90 340,65 390,50 C440,35 480,45 540,25 L600,15 L600,200 L0,200Z"
                    fill="url(#cg)"
                  />
                </svg>
                <div className="absolute right-0 top-0 h-full flex flex-col justify-between text-right py-1">
                  {["$28k", "$26k", "$24k", "$22k"].map((v) => (
                    <span key={v} className="text-[9px] text-zinc-700">
                      {v}
                    </span>
                  ))}
                </div>
            ...
            <div className="p-5">
              ...
              <div className="mt-3 p-3 rounded-xl border border-[#ff0033]/[0.15] bg-[#ff0033]/5">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-[#ff0033] text-[9px] font-semibold uppercase tracking-widest">
                    Sentinel
                  </p>
                  <p className="text-[#ff0033] text-[10px] font-black">
                    94/100
                  </p>
                </div>
